    ...
    def playGame(self):
        ...
        while len(self.getValidMoves(current_board)) != 0:  # 9 possible squares to fill
            ...
            if win_state == 0:
                ...
                # swap current player -> let me go
                choice_index_1_d = int(input("Index of Square: "))
                current_board = self.makeMove(current_board, choice_index_1_d, not is_black)
            elif win_state == 1:
